...
console.log("fixed" + numberOfColumnsFixedInt)
console.log("columns" + numberOfColumnsInt)
console.log("skips" + numberOfUnitSkipsInt)

let caculateDecimal = (numberOfColumnsInt - numberOfColumnsFixedInt) / numberOfUnitSkipsInt;
console.log("vejde  " + caculateDecimal)


var beforeDecimal = Math.trunc((numberOfColumnsInt - numberOfColumnsFixedInt) / numberOfUnitSkipsInt);
 console.log("bez decimal  " +beforeDecimal)

 var decimal = caculateDecimal - Math.floor(caculateDecimal)
 console.log("bez number  " +decimal)

 if(decimal > 0 && caculateDecimal > 0){
    beforeDecimal = beforeDecimal + 1
    console.log("kolikrat se bude muset kliknout  " +beforeDecimal)
 }


 console.log( Math.round(caculateDecimal))
